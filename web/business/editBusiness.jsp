            ...
            <div>
                <div class="container align-center">
                    <div class="youplay-form">
                        ...
                        <form method="post" action="editBusiness">
                            ...
                            <div class="youplay-input">
                                <input type="text" name="username" placeholder="Username" autofocus required="required" value="${business.name}" />
                            </div>
                            <div class="youplay-input">
                                <input type="text" name="password" placeholder="Password" required="required" value="${business.password}" />
                            </div>

                            <div class="youplay-input">
                                <input type="text" name="address" onkeypress="return alpha(event,letters)"  placeholder="Address"  required="required" value="${business.address}" />
                            </div>

                            <div class="youplay-input">
                                <input type="text" id="datepicker" name="established_date" placeholder="Established Date" value="${business.established_date}">
                            </div>

                            <div class="youplay-input">
                                <input type="number" min="0" name="gross_income" placeholder="Gross Income" required="required" value="${business.gross_income}" />
                            </div>
